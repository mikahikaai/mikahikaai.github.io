...
if (isset($_GET['page'])) {
  ...
  switch ($page) {
    ...
    case 'home':
      ...
      break;
    case 'penjualanread':
      file_exists('pages/penjualan/penjualanread.php') ? include 'pages/penjualan/penjualanread.php' : include '../pages/404.php';
      $title = 'Penjualan';
      break;
    case 'penjualancreate':
      file_exists('pages/penjualan/penjualancreate.php') ? include 'pages/penjualan/penjualancreate.php' : include '../pages/404.php';
      $title = 'Penjualan';
      break;
    case 'penjualanupdate':
      file_exists('pages/penjualan/penjualanupdate.php') ? include 'pages/penjualan/penjualanupdate.php' : include '../pages/404.php';
      $title = 'Penjualan';
      break;
    case 'penjualandelete':
      file_exists('pages/penjualan/penjualandelete.php') ? include 'pages/penjualan/penjualandelete.php' : include '../pages/404.php';
      $title = 'Penjualan';
      break;
    ...
    case 'pembeliandetail':
      ...
      $title = 'Pembelian';
      break;
    case 'dopenjualancreate':
      file_exists('pages/penjualan/dopenjualancreate.php') ? include 'pages/penjualan/dopenjualancreate.php' : include '../pages/404.php';
      $title = 'Penjualan';
      break;
    case 'dopenjualanupdate':
      file_exists('pages/penjualan/dopenjualanupdate.php') ? include 'pages/penjualan/dopenjualanupdate.php' : include '../pages/404.php';
      $title = 'Penjualan';
      break;
    case 'pelayananread':
