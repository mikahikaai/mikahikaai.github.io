...
$selectsql = 'SELECT * FROM pelayanan p inner join data_pelanggan dp on p.id_pelanggan = dp.id_pelanggan inner join data_dokter dd on p.id_dokter = dd.id_dokter ORDER BY tgl_pelayanan ASC';
...
<table style="width: 100%; margin-bottom: 10px;">
  <tr>
    <td align="center" style="font-weight: bold; padding-bottom: 20px; font-size: x-large;"><u>DATA REKAP PELAYANAN</u></td>
  </tr>
</table>
