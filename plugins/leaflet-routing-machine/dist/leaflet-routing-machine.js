...
module.exports={
    ...
    "v5": {
        ...
        "arrive": {
            "default": {
                "default": "Anda telah tiba di tujuan",
                "upcoming": "Anda telah tiba di tujuan",
                "short": "Anda telah tiba di tujuan",
                "short-upcoming": "Anda telah tiba di tujuan",
                "named": "Anda telah tiba di {waypoint_name}"
            },
            "left": {
                "default": "Anda telah tiba di tujuan, tujuan berada di sebelah kiri Anda",
                "upcoming": "Anda telah tiba di tujuan, tujuan berada di sebelah kiri Anda",
                "short": "Anda telah tiba di tujuan",
                "short-upcoming": "Anda telah tiba di tujuan",
                "named": "Anda telah tiba di {waypoint_name}, tujuan berada di sebelah kiri Anda"
            },
            "right": {
                "default": "Anda telah tiba di tujuan, tujuan berada di sebelah kanan Anda",
                "upcoming": "Anda telah tiba di tujuan, tujuan berada di sebelah kanan Anda",
                "short": "Anda telah tiba di tujuan",
                "short-upcoming": "Anda telah tiba di tujuan",
                "named": "Anda telah tiba di {waypoint_name}, tujuan berada di sebelah kanan Anda"
            },
            "sharp left": {
                "default": "Anda telah tiba di tujuan, tujuan berada di sebelah kiri Anda",
                "upcoming": "Anda telah tiba di tujuan, tujuan berada di sebelah kiri Anda",
            ...
            "straight": {
                "default": "Anda telah tiba di tujuan, lurus saja",
                "upcoming": "Anda telah tiba di tujuan, lurus saja",
                "short": "Anda telah tiba di tujuan",
                "short-upcoming": "Anda telah tiba di tujuan",
        ...
        "roundabout turn": {
            "default": {
                "default": "Ambil {modifier}",
                "name": "Ambil {modifier} ke arah {way_name}",
                "destination": "Ambil {modifier} menuju {destination}"
            },
            "left": {
                "default": "Belok kiri",
	...
	module.exports = L.extend(Localization, {
        ...
        'id': {
			directions: {
				...
				Right: 'kanan',
				SharpRight: 'ke kanan tajam',
				SlightLeft: 'sedikit ke kiri',
				Left: 'kiri',
				SharpLeft: 'ke kiri tajam',
				Uturn: 'Putar balik'
			},
			instructions: {
				// instruction, postfix if the road is named
				'Head':
					['Menuju {dir}', ' pada {road}'],
				'Continue':
					['Lanjut {dir}'],
				'TurnAround':
					['Putar balik'],
				'WaypointReached':
					['Sudah dititik jalan'],
				'Roundabout':
					['Ambil ke {exitStr} keluar di bundaran', ' menuju {road}'],
				'DestinationReached':
					['Sudah sampai tujuan'],
				'Fork': ['Di persimoangan, belok {modifier}', ' menuju {road}'],
				'Merge': ['Merge {modifier}', ' menuju {road}'],
				'OnRamp': ['Belok {modifier} di jalan', ' menuju {road}'],
				'OffRamp': ['Ambil jalan di {modifier}', ' menuju {road}'],
				'EndOfRoad': ['Belok {modifier} di akhir jalan', ' menuju {road}'],
				'Onto': 'Menuju {road}'
			},
			formatOrder: function (n) {
				var i = n % 10 - 1,
