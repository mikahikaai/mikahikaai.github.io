...
<script>
  ...
  $(document).ready(function() {
    ...
    } else if (title == "Rekap Pembelian") {
      $("a#rekappembelian").addClass("active");
      $("li#rekapitulasi_data").addClass("menu-open");
      $("a#link_rekapitulasi_data").addClass("active");
    } else if (title == "Rekap Penjualan") {
      $("a#rekappenjualan").addClass("active");
      $("li#rekapitulasi_data").addClass("menu-open");
      $("a#link_rekapitulasi_data").addClass("active");
    } else if (title == "Obat") {
