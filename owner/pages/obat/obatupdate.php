...
if (isset($_POST['button_edit'])) {
  ...
  $updatesql = "UPDATE obat SET nama_obat=?, jenis_obat=?, harga_jual=?, minimal_stok=?, stok_obat=?, khasiat=?, efek_samping=?  WHERE id_obat=?";
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <br>
              <textarea style="text-transform: uppercase;" name="khasiat" rows="4"><?= $row['khasiat'] ?></textarea>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="efek_samping">Efek Samping</label>
              <textarea style="text-transform: uppercase;" name="efek_samping" rows="4"><?= $row['efek_samping'] ?></textarea>
            </div>
          </div>
        </div>
